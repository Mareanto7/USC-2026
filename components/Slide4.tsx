    ...
    return (
        <section className="relative h-screen w-full flex items-center justify-center text-white overflow-hidden">
            <div className="absolute top-0 left-0 w-full z-20 bg-[#e74528] h-64">
                <h1 className="text-white text-center mt-12 mb-6 text-xl md:text-3xl max-w-screen-xl mx-auto uppercase whitespace-pre-line font-bold tracking-[0.4em] mb-0.5">
